        ...
        $(document).ready(function()
        {
          $('#hesapla').click(function(){
            ...
            $.ajax({
              url:"islem.php",
              method:"POST",
              data:{action:"hesapla", "cam_tipi":cam_tipi ,"kumlama":kumlama, "suluk":suluk, "profil_tipi":profil_tipi, "yuzde":yuzde,"kulp":kulp,"cam-olcu":cam_olcu, "delik":delik, "hsecim":"180"},
          ...
          <table class="w-100">
            ...
            <td>
              <select class="form-control" id="cam-tipi">
                <option>Cam Kalınlığı Seçiniz...</option>
                <option value="15">4 mm Kavisli</option>
                <option value="17">5 mm Kavisli</option>
                <option value="20">6 mm Kavisli</option>
              </select>
            </td>
            <tr><!-- satır -->
              <td>CAM ÖLÇÜSÜ : </td>

    ...
    <script type="text/javascript">
        ...
        $(document).ready(function()
        {
            $('#hesapla').click(function(){
                ...
                var suluk = $("#suluk").val();
                var h_cam_tipi = $("#h_cam-tipi").val();
                var s_cam_tipi = $("#s_cam-tipi").val();
                ...
                $.ajax({
                    url:"islem.php",
                    method:"POST",
                    data:{action:"hesapla", "s_cam_tipi":s_cam_tipi, "h_cam_tipi":h_cam_tipi ,"kumlama":kumlama, "suluk":suluk, "profil_tipi":profil_tipi, "yuzde":yuzde,"kulp":kulp,"cam-olcu":cam_olcu, "delik":delik, "h_secim":h_secim},
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-3 col-lg-6 inputlar">
                    ...
                    <table class="w-100">
                        ...
                        <tr>
                            <td>Hareketli Cam Tipi</td>
                            <td>
                                <select class="form-control" id="h_cam-tipi">
                                    <option>Hareketli Cam Tipi Seçiniz...</option>
                        ...
                        <tr>
                            <td>Sabit Cam Tipi</td>
                            <td>
                                <select class="form-control" id="s_cam-tipi">
                                    <option>Sabit Cam Tipi Seçiniz...</option>
                                    <option value="14">4mm Şeffaf</option>
                                    <option value="15">4mm Bombeli</option>
                                    <option value="16">5mm Şeffaf</option>
                                    <option value="17">5mm Bombeli</option>

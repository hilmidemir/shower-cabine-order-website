                  ...
                  <div class="row mt-3">
                    <div class="col-sm-3">
                      <div class="position-relative">
                        <img src="../img/photo.jpg" alt="Photo 1" class="img-fluid">
                    ...
                    <div class="col-sm-3">
                      <div class="position-relative">
                        <img src="../img/photo.jpg" alt="Photo 2" class="img-fluid">
                        <div class="ribbon-wrapper ribbon-xl">
                    ...
                    <div class="col-sm-3">
                      ...
                      <div class="w-100 text-right" style="">
                        <div class="col-8 btn btn-danger" id="siparisver" >SİPRARİŞ VER</div>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="position-relative">
                        <img src="../img/photo.jpg" alt="Photo 3" class="img-fluid">
                        <div class="ribbon-wrapper ribbon-xl">
                      ...
                      <div class="w-100 text-right ribboon">
                        <div class="col-8 btn btn-danger" id="siparisver" >SİPRARİŞ VER</div>
                      </div>
                    </div>
                  </div>
